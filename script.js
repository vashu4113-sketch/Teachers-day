...
/*
   CHANGE THIS ONLY IF YOUR EVENT DATE/TIME CHANGES.
...
/* Remember when countdown started */

const countdownStartKey =
  'teachersDayCountdownStart';

let countdownStart =
  localStorage.getItem(countdownStartKey);
